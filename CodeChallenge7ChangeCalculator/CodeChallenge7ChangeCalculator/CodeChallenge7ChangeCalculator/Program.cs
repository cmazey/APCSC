...
int change = Convert.ToInt32(Console.ReadLine()); // Input Value

int Quarters = (change / 25); // Multiply the change value by 25
int Dimes = (change - (Quarters * 25)) / 10; // Multiply the quarter by 25, then subtract the change value, and divide it by 10.
int Nickels = (change - (Quarters * 25 + Dimes * 10)) / 5; // Multiply the Quarter, and dime. Then add it altogether, then subtract it by the change value, and then divide it by 5.
